...
async function crafting(message, commandBody, stat) {
    ...
    if (arrayName[0] === 'work' && arrayName[1] === 'bench') {
        ...
        craftBar(message, id, username, copperBarId, materialList.copperBar, '<:Copper_Bar:803907956478836817>', arrayName[0], arrayName[1], craftQty);
    } else if (arrayName[0] === 'iron' && arrayName[1] === 'bar') {
        craftBar(message, id, username, ironBarId, materialList.ironBar, '<:Iron_Bar:803907956528906241>', arrayName[0], arrayName[1], craftQty);
    } else if (arrayName[0] === 'silver' && arrayName[1] === 'bar') {
        craftBar(message, id, username, silverBarId, materialList.silverBar, '<:Silver_Bar:803907956663910410>', arrayName[0], arrayName[1], craftQty);
    } else if (arrayName[0] === 'tungsten' && arrayName[1] === 'bar') {
        craftBar(message, id, username, tungstenBarId, materialList.tungstenBar, '<:Tungsten_Bar:803907956252344331>', arrayName[0], arrayName[1], craftQty);
    } else if (arrayName[0] === 'gold' && arrayName[1] === 'bar') {
        craftBar(message, id, username, goldBarId, materialList.goldBar, '<:Gold_Bar:803907956424441856>', arrayName[0], arrayName[1], craftQty);
    } else if (arrayName[0] === 'platinum' && arrayName[1] === 'bar') {
        craftBar(message, id, username, platinumBarId, materialList.platinumBar, '<:Platinum_Bar:803907956327317524>', arrayName[0], arrayName[1], craftQty);
        ...
        if (craftQty === '2') {
            ...
            message.channel.send(new Discord.MessageEmbed({
                ...
                fields: [
                    ...
                    {
                        value: `<:Light27s_Bane:827782177764802562>[+80 att]__light bane__ : 5 <:Tungsten_Bar:803907956252344331> + 10 <:Shadow_Scale:827782125398786068> ➜ <:Iron_Anvil:804145327435284500>` +
            ...
            message.channel.send(new Discord.MessageEmbed({
                ...
                fields: [
                    ...
                    {
                        value: `<:Night27s_Edge:828623529648979998>[+150 att]__night edge__ : 1000 <:Wood:804704694420766721> + 1 <:Ice_Blade:827782178099298325> + 1 <:Mandible_Blade:827804986934951946> + 1 <:Blade_of_Grass:827782177982251018> + 1 <:Light27s_Bane:827782177764802562> + 1 <:Blood_Butcherer:827782178129444874> ➜ <:Iron_Anvil:804145327435284500>`,
                        name: "Level 55",
                        inline: false
                    },
                    {
...
async function craftWeapon(message, playerId, username, itemName, args1, args2, item) {
    ...
    if (existStations.length > 0) {
        ...
        // } else {
            if (itemName === 'wooden sword') {
            ...
            } else if (itemName === `light bane`) {
                queryEquipment(message, playerId, materialList.lightsBane, 1, 21, item);
                ...
                queryEquipment(message, playerId, materialList.nightEdge, 1, 23, item);
            }
        // }
    } else {
        let stations = '';
